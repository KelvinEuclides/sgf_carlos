...
@section('page-title')
    {{__('Edit Bill').' '.\Auth::user()->billNumberFormat($bill->bill_id)}}
@endsection
@php
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush table-striped" data-repeater-list="items" id="sortable-table">
                                ...
                                <tr data-repeater-item>
                                    ...
                                    <td width="25%">
                                        {{ Form::select('item', $items,null, array('class' => 'form-control item select2','data-url'=>route('bill.product'),'required'=>'required')) }}
                                    </td>
                                    <td>
                                        <div class="form-group">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <div class="input-group colorpickerinput">
                                                <div class="taxes"></div>
                                                {{ Form::hidden('tax_id',null, array('class' => 'form-control tax')) }}
