                        ...
                        <div data-v-136bf9b5="" class="d preview-d" id="boxes">
                            <div data-v-136bf9b5="" class="d-inner">
                                <div data-v-136bf9b5="" class="row">
                                    ...
                                    <div data-v-136bf9b5="" class="col-33 text-right">
                                        <h1 data-v-136bf9b5="" class="fancy-title mb5 font-color">{{__('BILL')}}</h1></div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="bill_to">
                                        ...
                                        <p>
                                            {{!empty($vendor->vendors)?$vendor->vendors['billing_name']:''}}<br>
                                            {{!empty($vendor->vendors)?$vendor->vendors['billing_phone']:''}}<br>
                                            {{!empty($vendor->vendors)?$vendor->vendors['billing_address']:''}}<br>
                                            {{!empty($vendor->vendors)?$vendor->vendors['billing_zip']:''}}<br>
                                            {{!empty($vendor->vendors)?$vendor->vendors['billing_city']:'' .', '}} {{!empty($vendor->vendors)?$vendor->vendors['billing_state']:'',', '}} {{!empty($vendor->vendors)?$vendor->vendors['billing_country']:''}}
                                        </p>
                                    </div>
                                    @if($settings['shipping_display']=='on')
                                        <div class="ship_to">
                                            ...
                                            <p>
                                                {{!empty($vendor->vendors)?$vendor->vendors['shipping_name']:''}}<br>
                                                {{!empty($vendor->vendors)?$vendor->vendors['shipping_phone']:''}}<br>
                                                {{!empty($vendor->vendors)?$vendor->vendors['shipping_address']:''}}<br>
                                                {{!empty($vendor->vendors)?$vendor->vendors['shipping_zip']:''}}<br>
                                                {{!empty($vendor->vendors)?$vendor->vendors['shipping_city']:'' . ', '}} {{!empty($vendor->vendors)?$vendor->vendors['shipping_state']:'' .', '}},{{!empty($vendor->vendors)?$vendor->vendors['shipping_country']:''}}
                                            </p>
                                        </div>
                                    @endif
                                </div>
                                    ...
                                    <div data-v-136bf9b5="" class="col-33">
                                        <table data-v-136bf9b5="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{\App\Utility::billNumberFormat($settings,$bill->bill_id)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb font-color" >{{__('Issue Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{\App\Utility::dateFormat($settings,$bill->issue_date)}}</td>
                                            </tr>
                                        ...
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item border-color-top" >
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$bill->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
