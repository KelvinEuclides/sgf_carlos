        ...
        <div class="card-header actions-toolbar border-0 action-card-header">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col text-right">
                    <div class="actions">
                        {{ Form::open(array('route' => array('vendor.bill'),'method' => 'GET','id'=>'frm_submit')) }}
                        <div class="row d-flex justify-content-end">
                            ...
                            <div class="col-auto my-auto">
                                ...
                                <a href="{{route('vendor.bill')}}" class="reset-btn" data-toggle="tooltip" data-original-title="{{__('Reset')}}">
                    ...
                    <tr class="font-style">
                        ...
                        <td class="Action text-right">
                            <div class="actions ml-3">
                                ...
                                <a href="{{ route('vendor.bill.show',\Crypt::encrypt($bill->id)) }}" class="action-item" data-toggle="tooltip" data-original-title="{{__('Show')}}">
