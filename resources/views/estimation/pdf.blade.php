...
<head>
    ...
    <style type="text/css">p[data-v-b8f60a0c] {
        ...
        .border-color {
            border-bottom: 1px solid #0e3666;
        }

        .border-color-top {
            border-bottom: 1px solid #0e3666;
            border-top: 1px solid #0e3666;
        }
                        ...
                        <div data-v-136bf9b5="" class="d preview-d" id="boxes">
                            <div data-v-136bf9b5="" class="d-inner">
                                <div data-v-136bf9b5="" class="row">
                                    ...
                                    <div data-v-136bf9b5="" class="col-33 text-right"><h1 data-v-136bf9b5="" class="fancy-title mb5 font-color">{{__('ESTIMATION')}}</h1></div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="bill_to">
                                        ...
                                        <p>
                                            {{!empty($customer->customers)?$customer->customers['billing_name']:''}}<br>
                                            {{!empty($customer->customers)?$customer->customers['billing_phone']:''}}<br>
                                            {{!empty($customer->customers)?$customer->customers['billing_address']:''}}<br>
                                            {{!empty($customer->customers)?$customer->customers['billing_zip']:''}}<br>
                                            {{!empty($customer->customers)?$customer->customers['billing_city']:'' .', '}} {{!empty($customer->customers)?$customer->customers['billing_state']:'',', '}} {{!empty($customer->customers)?$customer->customers['billing_country']:''}}
                                        </p>
                                    </div>
                                    @if($settings['shipping_display']=='on')
                                        <div class="ship_to">
                                            ...
                                            <p>
                                                {{!empty($customer->customers)?$customer->customers['shipping_name']:''}}<br>
                                                {{!empty($customer->customers)?$customer->customers['shipping_phone']:''}}<br>
                                                {{!empty($customer->customers)?$customer->customers['shipping_address']:''}}<br>
                                                {{!empty($customer->customers)?$customer->customers['shipping_zip']:''}}<br>
                                                {{!empty($customer->customers)?$customer->customers['shipping_city']:'' . ', '}} {{!empty($customer->customers)?$customer->customers['shipping_state']:'' .', '}},{{!empty($customer->customers)?$customer->customers['shipping_country']:''}}
                                            </p>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div data-v-136bf9b5="" class="row">
                                    <div data-v-136bf9b5="" class="col-33">
                                        <table data-v-136bf9b5="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb font-color">{{__('Number')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{\App\Utility::estimationNumberFormat($settings,$estimation->estimation_id)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb font-color">{{__('Issue Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{\App\Utility::dateFormat($settings,$estimation->issue_date)}}</td>
                                            </tr>
                                ...
                                <div data-v-136bf9b5="" class="d-table">
                                    <div data-v-136bf9b5="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table-tr font-color-bg">
                                        ...
                                        <div class="d-table-body">
                                            @if(isset($estimation->items) && count($estimation->items) > 0)
                                                @foreach($estimation->items as $key => $item)

                                                    <div class="d-table-tr border-color">
                                        ...
                                        <div class="d-table-tr border-color">
                                            ...
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{$estimation->totalQuantity}}</pre>
                                            </div>
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$estimation->totalRate)}}</pre>
                                            </div>
                                            <div class="d-table-td w-6">
                                                <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$estimation->totalTaxPrice) }}</pre>
                                            </div>
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$estimation->totalDiscount)}}</pre>
                                            </div>

                                            <div class="d-table-td w-4 text-right">
                                                    <span>{{\App\Utility::priceFormat($settings,$estimation->getSubTotal())}}
                                                    </span>
                                            </div>
                                        </div>
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                @if($estimation->getTotalDiscount())
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Discount')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$estimation->getTotalDiscount())}}</div>
                                                    </div>
                                                @endif

                                                @if(!empty($estimation->taxesData))
                                                    @foreach($estimation->taxesData as $taxName => $taxPrice)
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item border-color-top">
                                                    <div data-v-f2a183a6="" class="d-table-label">{{__('Total')}}:</div>
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$estimation->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
