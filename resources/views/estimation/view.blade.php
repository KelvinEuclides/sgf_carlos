...
@section('action-button')
    ...
    @if($estimation->status==0)
        <div class="Action">
            @can('send estimation')
                <a href="{{ route('estimation.sent',$estimation->id) }}" class="btn btn-sm btn-create btn-icon-only rounded-circle ml-2" data-toggle="tooltip" data-original-title="{{__('Mark Sent')}}"><i class="fa fa-paper-plane"></i></a>
            @endcan
        </div>
    ...
    @if(\Auth::user()->type=='company')
        @if($estimation->status!=0)
            <a href="{{ route('estimation.resent',$estimation->id) }}" class="btn btn-sm btn-create btn-icon-only rounded-circle ml-2" data-toggle="tooltip" data-original-title="{{__('Resend Estimation')}}"><i class="fa fa-paper-plane"></i></a>
    ...
    @can('edit estimation')
        <a href="{{ route('estimation.edit',$estimation->id) }}" class="btn btn-sm btn-create btn-icon-only rounded-circle ml-2" data-size="lg" data-title="{{__('Edit Estimation')}}" class="action-item" data-toggle="tooltip" data-original-title="{{__('Edit')}}">
