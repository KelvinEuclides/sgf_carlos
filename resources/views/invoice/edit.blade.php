...
@section('page-title')
    {{__('Edit Invoice').' '.\Auth::user()->invoiceNumberFormat($invoice->invoice_id)}}
@endsection
@php
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush table-striped" data-repeater-list="items" id="sortable-table">
                                ...
                                <tr data-repeater-item>
                                    ...
                                    <td width="25%">
                                        {{ Form::select('item', $items,null, array('class' => 'form-control item select2','data-url'=>route('invoice.product'),'required'=>'required')) }}
                                    </td>
                                    <td>
                                        <div class="form-group">
