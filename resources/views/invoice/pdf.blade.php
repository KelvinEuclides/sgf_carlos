                        ...
                        <div data-v-136bf9b5="" class="d preview-d"  id="boxes">
                            <div data-v-136bf9b5="" class="d-inner">
                                <div data-v-136bf9b5="" class="row">
                                    ...
                                    <div data-v-136bf9b5="" class="col-33 text-right"><h1 data-v-136bf9b5="" class="fancy-title mb5 font-color">{{__('INVOICE')}}</h1></div>
                                </div>
                                    ...
                                    <div data-v-136bf9b5="" class="col-33">
                                        <table data-v-136bf9b5="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{\App\Utility::invoiceNumberFormat($settings,$invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb font-color">{{__('Issue Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{\App\Utility::dateFormat($settings,$invoice->issue_date)}}</td>
                                            </tr>
                                ...
                                <div data-v-136bf9b5="" class="d-table">
                                    <div data-v-136bf9b5="" class="d-table">
                                        ...
                                        <div class="d-table-tr border-color">
                                            ...
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$invoice->totalRate)}}</pre>
                                            </div>
                                            <div class="d-table-td w-6">
                                                <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$invoice->totalTaxPrice) }}</pre>
                                            </div>
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{\App\Utility::priceFormat($settings,$invoice->totalDiscount)}}</pre>
                                            </div>

                                            <div class="d-table-td w-4 text-right">
                                                    <span>{{\App\Utility::priceFormat($settings,$invoice->getSubTotal())}}
                                                    </span>
                                            </div>
                                        </div>
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item border-color-top">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Utility::priceFormat($settings,$invoice->getTotal())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
