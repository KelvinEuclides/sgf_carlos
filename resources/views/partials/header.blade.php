            ...
            <ul class="navbar-nav flex-row align-items-center">
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link " href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="h6 text-sm mb-0"><i class="fas fa-award"></i>  {{Str::upper($currantLang)}}</span>
                    </a>
                ...
                <li class="nav-item dropdown dropdown-animate">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right dropdown-menu-arrow">
                        <h6 class="dropdown-header px-0">{{\Auth::user()->name}}</h6>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                        @if(\Auth::user()->type=='super admin')
                            <a class="dropdown-item" href="{{route('manage.language',[$currantLang])}}">{{ __('Create New Language') }}</a>
                        @endif
                        @foreach($languages as $language)
                            <a href="{{route('change.language',$language)}}" class="dropdown-item @if($language == $currantLang) active-language @endif">
                                <span> {{Str::upper($language)}}</span>
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right dropdown-menu-arrow">
                        ...
                        @can('manage role')
                            <a href="{{route('roles.index')}}" class="dropdown-item">
                                <i class="fas fa-user-tag"></i> <span>{{__('Roles')}}</span>
                            </a>
                        @endcan
                        <div class="dropdown-divider"></div>
