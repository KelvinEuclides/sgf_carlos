    ...
    <script>
        ...
        var SalesChart = {
            series: [
                {
                    name: "{{__('Estimation')}}",
                    data: {!! json_encode($estimationTotal) !!}
                }
            ],
...
@section('action-button')
    ...
    <a href="{{route('estimation.summary.list')}}"  data-toggle="tooltip" data-title="{{__('List View')}}" class="btn btn-sm btn-white btn-icon-only rounded-circle "><i class="fas fa-th-list"></i></a>
@endsection
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="collapse {{isset($_GET['start_month']) || isset($_GET['end_month']) || isset($_GET['customer']) || isset($_GET['status'])?'show':''}}" id="collapseExample">
                <div class="card card-body">
                    <div class="row d-flex justify-content-end">
                        <div class="col">
                            {{ Form::open(array('route' => array('estimation.summary'),'method' => 'GET','id'=>'estimation_summary')) }}
                        ...
                        <div class="col-auto my-auto">
                            ...
                            <a href="{{route('estimation.summary')}}" class="btn btn-sm btn-primary mr-auto" data-toggle="tooltip" data-original-title="{{__('Reset Now')}}">
