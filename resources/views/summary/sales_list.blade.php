...
@section('action-button')
    ...
    <a href="{{route('sales.summary')}}"  data-toggle="tooltip" data-title="{{__('Chart View')}}" class="btn btn-sm btn-white btn-icon-only rounded-circle "><i class="fas fa-chart-bar"></i></a>
@endsection
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="collapse {{isset($_GET['start_month']) || isset($_GET['end_month']) || isset($_GET['customer']) || isset($_GET['status'])?'show':''}}" id="collapseExample">
                <div class="card card-body">
                    <div class="row d-flex justify-content-end">
                        <div class="col">
                            {{ Form::open(array('route' => array('sales.summary.list'),'method' => 'GET','id'=>'estimation_summary')) }}
                        ...
                        <div class="col-auto my-auto">
                            ...
                            <a href="{{route('sales.summary.list')}}" class="btn btn-sm btn-primary mr-auto" data-toggle="tooltip" data-original-title="{{__('Reset Now')}}">
    ...
    <div id="printableArea">
            ...
            <div class="col-12" id="invoice-container">
                <div class="card">
                    <div class="card-header">
                        <h6 class="header__title">{{__('Income')}}</h6>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-12" id="invoice-container">
                <div class="card">
                    <div class="card-header">
                        <h6 class="header__title">{{__('Invoice')}}</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped mb-0" id="dataTable-manual">
...
{{--                                </tr>--}}
        ...
        <div class="row">
            <div class="col-12" id="invoice-container">
                <div class="card">
                    <div class="card-header">
                        <h6 class="header__title">{{__('Sales = Income + Invoice')}}</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped mb-0" id="dataTable-manual">
