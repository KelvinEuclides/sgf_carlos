{{ Form::open(array('url' => 'voucher','method' =>'post')) }}
<div class="row">
    ...
    <div class="form-group col-md-12 d-none" id="auto">
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="#" class="btn btn-sm btn-create btn-icon-only rounded-circle ml-4" id="code-generate"><i class="fas fa-history"></i></a>
            </div>
        </div>
    </div>
