...
<?php $__env->startSection('container'); ?>
    ...
    <p class="text-danger"><strong>Default Super Admin Created : superadmin@example.com / 1234</strong></p>
    <p class="text-danger"><strong>Default Company Created : company@example.com / 1234</strong></p>
    <p class="text-danger"><strong>Default Manager Created : manager@example.com / 1234</strong></p>
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/vendor/installer/finished.blade.php ENDPATH**/ ?>